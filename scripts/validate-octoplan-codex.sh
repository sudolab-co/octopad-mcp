...
[ "$skill_version" = '1.4.1' ] || fail 'Codex SKILL.md is not 1.4.1'
...
require_contract "$conformance" '# Octoplan Codex 1.4.1 conformance'
...
printf 'PASS: Octoplan Codex 1.4.1 contract (%s words, %s validator lines)\n' "$active_words" "$validator_lines"
