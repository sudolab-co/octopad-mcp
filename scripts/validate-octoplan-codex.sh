...
[ "$skill_version" = '1.3.2' ] || fail 'Codex SKILL.md is not 1.3.2'
...
require_contract "$conformance" '# Octoplan Codex 1.3.2 conformance'
...
printf 'PASS: Octoplan Codex 1.3.2 contract (%s words, %s validator lines)\n' "$active_words" "$validator_lines"
