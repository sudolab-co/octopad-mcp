...
grep -Fq '| [`octoplan-codex`](plugins/octoplan-codex/skills/octoplan/SKILL.md) | Codex | 17.2.0 | Builds a lean governed plan, challenges it once, then supervises authorized delivery from Octopad. |' "$root/README.md" || fail 'README Codex version or behavior is stale'
