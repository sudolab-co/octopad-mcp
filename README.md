...
| [`octoplan-autopilot`](plugins/octoplan-autopilot/skills/octoplan-autopilot/SKILL.md) | Claude Code | 0.6.0 | Plans the work, agrees a delivery contract, then supervises delivery after an explicit go. |
