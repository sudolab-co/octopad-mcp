# Octoplan Codex 1.3.2 conformance
...
**Two numbers, two meanings.** The release version (`1.3.2`) identifies the published distribution. The plan-contract generation (`v18`, written on saved plans as `Octoplan 18 plan contract`) identifies which plans a supervisor may still execute. The 1.0.0 reset renumbered the distribution only, and the 1.1.0 through 1.3.2 releases create no new plan contract either; live v18 plans stay valid.
...
- [x] Skill `Version:` and plugin manifest use `1.3.2`.
