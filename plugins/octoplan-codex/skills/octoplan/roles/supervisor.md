...
Load this pack only for the fenced supervisor.
...
Own the outcome and the guarded ledger. Select native actors only when their substrate exposes the required capability, pass each child its role packet, and keep safe independent work moving.
