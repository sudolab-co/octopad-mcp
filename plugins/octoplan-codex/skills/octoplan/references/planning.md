...
10. **Ask before launch.** Report the verified plan and exact final hash, ask the runtime execution question, and stop. Do not create any execution session until a later explicit yes binds that hash.
